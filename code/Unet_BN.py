...
class Unet_BN(nn.Module):
    def __init__(self, n_class):
        ...
        self.last1 = nn.Conv2d(64, 32, kernel_size=9, stride=8, padding=0, bias=False)
        self.last2 = nn.Conv2d(32, n_class, kernel_size=9, stride=8, padding=0, bias=False)
    ...
    def forward(self, x):
        ...
        last_layer1 = self.last1(up4)
        last_layer2 = self.last2(last_layer1)
        return last_layer2